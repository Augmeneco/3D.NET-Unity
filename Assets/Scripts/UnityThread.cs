...
public class UnityThread : MonoBehaviour
{
    ...
    private static List<Pair<System.Action, Boolean>> actionQueuesUpdateFunc = new List<Pair<System.Action, Boolean>>();

    //holds Actions copied from actionQueuesUpdateFunc to be executed
    List<Pair<System.Action, Boolean>> actionCopiedQueueUpdateFunc = new List<Pair<System.Action, Boolean>>();
    ...
    public static void executeInUpdate(System.Action action)
    {
        ...
        Pair<System.Action, Boolean> pair = new Pair<System.Action, Boolean>(action, false);
        lock (actionQueuesUpdateFunc)
        {
            actionQueuesUpdateFunc.Add(pair);
    ...
    public void Update()
    {
        ...
        {
            actionCopiedQueueUpdateFunc[i].First.Invoke();
            actionCopiedQueueUpdateFunc[i].Second = true;
        }
    }
#endif
