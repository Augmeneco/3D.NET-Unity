...
public class FileReader {
	...
	public static ObjectFile ReadObjectFile (string data) {
		...
		foreach (string line in data.Split('\n')) {
			...
			case ("v"):
				obj.v.Add (new Vector3 (
					float.Parse (token [1], CultureInfo.InvariantCulture.NumberFormat),
					float.Parse (token [2], CultureInfo.InvariantCulture.NumberFormat),
					float.Parse (token [3], CultureInfo.InvariantCulture.NumberFormat)));
				break;
			case ("vn"):
	...
	public static MaterialFile ReadMaterialFile (string data) {
